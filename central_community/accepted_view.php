...
if(!isset($_GET['a'])){
    $Proposal_Id =$_SESSION['proposal_Id_a'];         
  }else{
    $Proposal_Id = $_SESSION['proposal_Id_a'] = $_GET['a'];
  }
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">
                                <a href="accepted.php" class="btn btn-primary btn-circle btn">
                                    <i class="fas fa-arrow-circle-left"></i>
                                </a> Back to Accepted Requests
                            </h6>
                        </div>
                        <div class="card-body">
                                ...
                                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">                        
                                            ...
                                            <div class="col-sm">
                                                <label><B>Department Remarks</B></label>
                                                <p class="border-bottom border-primary">
                                                <?PHP echo $project_row['department_remarks'];?>
                                                </p>
                                            </div>
                                            <div class="col-sm">
                                                <label><B>Central Commity Remarks</B></label>
                                                <p class="border-bottom border-primary">
                                                    <?PHP echo $project_row['central_remarks'];?>
                                                </p>
                                            </div>
                                    </div>
