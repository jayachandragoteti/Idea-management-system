...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item  active" id="rejected">
                                        ...
                                        <div class="col-sm-12">
                                            <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                                ...
                                                <tbody id="myTable">
                                                    <?PHP
                                                        $i=1;
                                                        $project="SELECT * FROM `project_proposals` WHERE `status` = 'Rejected at central committee.' AND `branch`='$branch'";
                                                        ...
                                                        echo"<td style='display:flex;justify-content: center;'>
                                                                <a href='rejected_view.php?r=".$_SESSION['proposal_Id_r']=$project_row['proposal_id']."' class='btn btn-primary btn-circle btn-sm'> <i class='far fa-file-alt'></i></a>
                                                             </td>
                                                            </tr>";
                                                        $i++; } 
                                                        ?>
