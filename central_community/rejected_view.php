...
if(!isset($_GET['r'])){
    $Proposal_Id =$_SESSION['proposal_Id_r'];         
  }else{
    $Proposal_Id = $_SESSION['proposal_Id_r'] = $_GET['r'];
  }
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">
                                <a href="rejected.php" class="btn btn-primary btn-circle btn">
                                    <i class="fas fa-arrow-circle-left"></i>
                                </a> Back to Rejected Requests
                            </h6>
                        </div>
                        <div class="card-body">
