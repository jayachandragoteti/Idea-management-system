...
if (isset($_POST['Accept'])) {
    ...
    $accept_status="Accepted at department and pendging at central committee.";
    
    $accept_query="UPDATE `project_proposals` SET `status`='$accept_status',`department_remarks`='$accept_remarks' WHERE `proposal_id`='$Proposal_Id'";
  ...
  $reject_status="Rejected at department.";
  
  $reject_query="UPDATE `project_proposals` SET `status`='$reject_status',`department_remarks`='$reject_Reject_remarks' WHERE `proposal_id`='$Proposal_Id'";
