          ...
          <!--=================================-->
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                      ...
                      <h6 class="m-0 font-weight-bold text-primary"><a href="central_committee_accepted.php" class="btn btn-primary btn-circle btn">
               ...
               <!------------------------>
                    ...
                    <h5 class="card-title">  Proposals details</h5>
                        ...
                        <div class="col">
                            ...
                            <div class="col">
                                <div class="form-group">
                                <label for="exampleInputPassword1"><b>Project Approval Document</b></label>
                                <br>
                                <a href="download_pdf.php" class="btn btn-primary btn-sm ">Print</a>
                                </div>
                            </div>
                        </div>
