                    ...
                    <div class="card-body">
                      ...
                      <div class="col-sm-12">
                        <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                          <thead>
                            <tr role="row">
                              <tr><th rowspan="1" colspan="1">Proposal id</th>
                                <th rowspan="1" colspan="1">Project name</th>
                                <th rowspan="1" colspan="1">Department rematks</th>
                                <th rowspan="1" colspan="1">Central committee rematks</th>
                                <th rowspan="1" colspan="1">Approved amount</th>
                          ...
                          <tbody id="myTable">
                          <?PHP 
                                  $sql="SELECT * FROM `project_proposals` WHERE  `id_number` = '$user' AND `status` like 'ACCEPTED%' ORDER BY `sno` DESC ";
                                  $result = mysqli_query($connect,$sql);
                                  
                                     while($row = mysqli_fetch_array($result)){
                                      echo "<tr role='row' class='even'><td>".$row['proposal_id']."</td><td>".$row['project_title']."</td><td>".$row['admin_remarks']."</td>
                                      <td>".$row['admin_remarks']."</td><td>".$row['approved_amount']."</td>
                                      <td style='display:flex;justify-content: center;'><a href='stu_faculty_accepted_view.php?k=".$row['proposal_id']."' class='btn btn-primary btn-circle btn-sm'> <i class='far fa-file-alt'></i></a> </td>
                                      </tr>";
