<?PHP
  ...
  if (isset($_POST['Accept'])) {
            ...
            $accept_status="ACCETPED AT DEPARTMENT LEVEL ,PENDING AT CENTRAL COMMITTEE";
            
            $accept_query="UPDATE `project_proposals` SET `status`='$accept_status',`admin_remarks`='$accept_remarks' WHERE `proposal_id`='$Proposal_Id'";
                      ...
                      if ($applicant_row['email'] !="") {
                                ...
                                $headers = "From:" . $from;
                                    ...
                                    if (mail($to1, $subject1,$message,$headers)){
                                      ...
                                      echo "<script>window.location='department_admin_pending.php';</script>";
                                    }else{
                                      echo "<script>window.location='department_admin_pending.php';</script>";
                                    }
                                    //
          ...
          $reject_status="REJECTED AT DEPARTMENT LEVEL";
          
          $reject_query="UPDATE `project_proposals` SET `status`='$reject_status',`admin_remarks`='$reject_Reject_remarks' WHERE `proposal_id`='$Proposal_Id'";
          ...
          <!--=================================-->
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                      ...
                      <h6 class="m-0 font-weight-bold text-primary"><a href="department_admin_pending.php" class="btn btn-primary btn-circle btn">
